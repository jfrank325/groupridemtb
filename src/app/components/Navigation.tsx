              ...
              <div className="flex flex-col py-4">
                ...
                {session && (
                  <>
                    ...
                    <Link
                      href="/profile"
                      className="px-4 py-3 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-emerald-600 transition-colors cursor-pointer"
                      onClick={closeMobileMenu}
                    >
                      Profile
                    </Link>
                ...
                {!session && (
                  <div className="px-4 py-3 border-t border-gray-200 mt-2">
                    <button
                      ...
                      className="w-full px-4 py-2 text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg transition-colors cursor-pointer"
                    >
                      Sign In
                    </button>
                  </div>
