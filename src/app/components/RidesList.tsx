...
export const RidesList = ({ title, rides, onTrailHover }: RidesListProps) => {
        ...
        <section className="w-full lg:w-1/2">
            ...
            {rides.length === 0 ? (
                <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                    ...
                    <p className="text-gray-500 text-lg">No rides scheduled yet.</p>
                    <p className="text-gray-400 text-sm mt-2">Be the first to create a ride!</p>
                </div>
            ) : (
                <div className="space-y-4">
                    {rides.map((ride) => (
                        <div
                            ...
                            className="bg-white rounded-xl border border-gray-200 p-6 hover:border-emerald-300 hover:shadow-lg transition-all cursor-pointer group"
                        >
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-100">
                                <div className="flex items-center gap-2 flex-wrap">
                                    <span className="text-xs font-medium text-gray-500">Trails:</span>
